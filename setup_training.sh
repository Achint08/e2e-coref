...
# ontonotes_path=~/Documents/dataset/e2e-coref/ontonotes-release-5.0
...
python filter_embeddings.py glove.6B.50d.txt train.english.jsonlines dev.english.jsonlines test.english.jsonlines
